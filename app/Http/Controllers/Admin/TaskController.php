...
class TaskController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $table->rawColumns(['actions', 'placeholder', 'status', 'tag', 'attachment', 'user_create', 'indenture']);
    ...
    public function create()
    {
        ...
        return view('admin.tasks.create', compact('statuses', 'tags', 'user_creates', 'indentures'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        return view('admin.tasks.edit', compact('statuses', 'tags', 'user_creates', 'indentures', 'task'));
    }
